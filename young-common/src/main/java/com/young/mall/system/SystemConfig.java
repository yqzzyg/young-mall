...
/**
 * @Description: 系统设置, 其他配置请参考该类的实现
 * @Author: yqz
 * @CreateDate: 2020/11/11 16:56
 */
public class SystemConfig extends BaseConfig {

    public static final String PRE_FIX = "young.system.";
    ...
    /**
     * 是否为多订单模式 young.system.multi.order.model 1表示是, 0 表示不拆单
     *
     * @return
     */
