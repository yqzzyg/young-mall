...
/**
 * @Description: RegexUtil类的代码是来自[AndroidUtilCode](https://github.com/Blankj/AndroidUtilCode)的RegexUtils类和RegexConstants类
...
public class RegexUtil {
     ...
     * @param input The input.
     * @param regex The regex.
     * @return the array of strings computed by splitting input around matches of
     * regex
     */
    ...
    /**
     * Replace the first subsequence of the input sequence that matches the regex
    ...
    /**
     * Replace every subsequence of the input sequence that matches the pattern with
