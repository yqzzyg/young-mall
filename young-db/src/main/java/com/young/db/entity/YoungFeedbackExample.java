...
public class YoungFeedbackExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addPicUrlsCriterion(String condition, Object value, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value, "com.young.db.utils.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addPicUrlsCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value1, value2, "com.young.db.utils.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
